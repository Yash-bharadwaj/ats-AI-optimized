...
from app.api.v1.api_vercel import api_router
...
logging.getLogger("app.api.v1.endpoints.resume_vercel").setLevel(logging.DEBUG)
logging.getLogger("app.services.file_processors_vercel").setLevel(logging.DEBUG)
